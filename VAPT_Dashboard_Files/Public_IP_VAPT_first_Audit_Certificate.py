...
# Create blueprint for Public IP VAPT First Audit Certificate generation
public_ip_vapt_first_audit_certificate_bp = Blueprint('public_ip_vapt_first_audit_certificate', __name__)
...
def generate_public_ip_vapt_first_audit_certificate(organization_name, city, state, auditee_designation, scope,
                                                    start_audit_date, end_audit_date, report_id):
    """
    Generate a Public IP VAPT First Audit Completion Certificate document by copying the template and replacing placeholders
    """
    try:
        # Path to the template file
        template_path = os.path.join('static', 'Formats_and_Catalog', 'Public_IP_VAPT_First_Audit_Conduct_Certificate.docx')
        ...
        import shutil
        certificate_filename = "Public_IP_VAPT_Certificate.docx"
...
@public_ip_vapt_first_audit_certificate_bp.route('/process_public_ip_vapt_first_audit_certificate', methods=['POST'])
def process_public_ip_vapt_first_audit_certificate():
    """
    Process the certificate form data and generate a Public IP VAPT First Audit Completion Certificate
    """
    try:
        # Get form data
        ...
        print("📋 Public IP Certificate Data Received:")
        print(f"   Organization: {organization_name}")
        print(f"   City: {city}")
        print(f"   State: {state}")
        print(f"   Auditee Designation: {auditee_designation}")
        ...
        certificate_path = generate_public_ip_vapt_first_audit_certificate(
        ...
        return send_file(
            certificate_path,
            as_attachment=True,
            download_name="Public_IP_VAPT_Certificate.docx",
            mimetype='application/vnd.openxmlformats-officedocument.wordprocessingml.document'
        )

    except Exception as e:
        print(f"❌ Error processing Public IP first audit certificate: {e}")
        traceback.print_exc()
