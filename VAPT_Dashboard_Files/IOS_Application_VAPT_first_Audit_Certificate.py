...
# Create blueprint for IOS Application VAPT First Audit Certificate generation
ios_app_vapt_first_audit_certificate_bp = Blueprint('ios_app_vapt_first_audit_certificate', __name__)
...
def generate_ios_app_vapt_first_audit_certificate(organization_name, city, state, auditee_designation, scope,
                                                  start_audit_date, end_audit_date, report_id):
    """
    Generate an IOS Mobile Application VAPT First Audit Completion Certificate document by copying the template and replacing placeholders
    """
    try:
        template_path = os.path.join('static', 'Formats_and_Catalog', 'IOS_Application_VAPT_First_Audit_Conduct_Certificate.docx')
        ...
        import shutil
        certificate_filename = "IOS_Application_VAPT_Certificate.docx"
...
@ios_app_vapt_first_audit_certificate_bp.route('/process_ios_app_vapt_first_audit_certificate', methods=['POST'])
def process_ios_app_vapt_first_audit_certificate():
    """
    Process the certificate form data and generate an IOS Mobile Application VAPT First Audit Completion Certificate
    """
    try:
        ...
        print("📋 IOS Application Certificate Data Received:")
        print(f"   Organization: {organization_name}")
        print(f"   City: {city}")
        print(f"   State: {state}")
        print(f"   Auditee Designation: {auditee_designation}")
        ...
        certificate_path = generate_ios_app_vapt_first_audit_certificate(
        ...
        return send_file(
            certificate_path,
            as_attachment=True,
            download_name="IOS_Application_VAPT_Certificate.docx",
            mimetype='application/vnd.openxmlformats-officedocument.wordprocessingml.document'
        )

    except Exception as e:
        print(f"❌ Error processing IOS Application first audit certificate: {e}")
        traceback.print_exc()
