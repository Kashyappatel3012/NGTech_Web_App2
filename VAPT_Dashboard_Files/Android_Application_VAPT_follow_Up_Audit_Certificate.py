...
# Create blueprint for Android Application VAPT Follow Up Audit Certificate generation
android_app_vapt_follow_up_audit_certificate_bp = Blueprint('android_app_vapt_follow_up_audit_certificate', __name__)
...
def generate_android_app_vapt_follow_up_audit_certificate(organization_name, city, state, auditee_designation, scope,
                                                          start_audit_date, end_audit_date, first_report_id, report_id):
    """Generate an Android Application VAPT Follow Up Audit Completion Certificate document."""
    try:
        template_path = os.path.join('static', 'Formats_and_Catalog', 'Android_Application_VAPT_Follow_Up_Audit_Conduct_Certificate.docx')
        ...
        import shutil
        certificate_filename = "Android_Application_VAPT_Follow_Up_Certificate.docx"
...
@android_app_vapt_follow_up_audit_certificate_bp.route('/process_android_app_vapt_follow_up_audit_certificate', methods=['POST'])
def process_android_app_vapt_follow_up_audit_certificate():
    """Process the form data and generate an Android Application VAPT Follow Up Audit Completion Certificate."""
    try:
        ...
        print("📋 Android Application Follow Up Certificate Data Received:")
        print(f"   Organization: {organization_name}")
        print(f"   City: {city}")
        print(f"   State: {state}")
        print(f"   Auditee Designation: {auditee_designation}")
        ...
        certificate_path = generate_android_app_vapt_follow_up_audit_certificate(
        ...
        return send_file(
            certificate_path,
            as_attachment=True,
            download_name="Android_Application_VAPT_Follow_Up_Certificate.docx",
            mimetype='application/vnd.openxmlformats-officedocument.wordprocessingml.document'
        )

    except Exception as e:
        print(f"❌ Error processing Android Application follow up audit certificate: {e}")
        traceback.print_exc()
