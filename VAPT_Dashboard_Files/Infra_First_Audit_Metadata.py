...
# Create blueprint for VAPT First Audit MetaData
vapt_first_audit_metadata_bp = Blueprint('vapt_first_audit_metadata', __name__)
...
def create_first_audit_metadata_excel(form_data):
    ...
    try:
        ...
        filename = f'First_Audit_MetaData_{timestamp}.xlsx'
...
@vapt_first_audit_metadata_bp.route('/process_vapt_first_audit_metadata', methods=['POST'])
def process_vapt_first_audit_metadata():
...
# Cleanup endpoint
@vapt_first_audit_metadata_bp.route('/cleanup_vapt_first_audit_metadata', methods=['POST'])
def cleanup_vapt_first_audit_metadata():
