...
# Create blueprint for API VAPT First Audit Certificate generation
api_vapt_first_audit_certificate_bp = Blueprint('api_vapt_first_audit_certificate', __name__)
...
def generate_api_vapt_first_audit_certificate(organization_name, city, state, auditee_designation, scope,
                                              start_audit_date, end_audit_date, report_id):
    """
    Generate an API VAPT First Audit Completion Certificate document by copying the template and replacing placeholders
    """
    try:
        template_path = os.path.join('static', 'Formats_and_Catalog', 'API_VAPT_First_Audit_Conduct_Certificate.docx')
        ...
        import shutil
        certificate_filename = "API_VAPT_Certificate.docx"
        ...
        print("📋 API Certificate Data Applied:")
...
@api_vapt_first_audit_certificate_bp.route('/process_api_vapt_first_audit_certificate', methods=['POST'])
def process_api_vapt_first_audit_certificate():
    """
    Process the certificate form data and generate an API VAPT First Audit Completion Certificate
    """
    try:
        ...
        print("📋 API Certificate Data Received:")
        print(f"   Organization: {organization_name}")
        print(f"   City: {city}")
        print(f"   State: {state}")
        print(f"   Auditee Designation: {auditee_designation}")
        ...
        certificate_path = generate_api_vapt_first_audit_certificate(
        ...
        return send_file(
            certificate_path,
            as_attachment=True,
            download_name="API_VAPT_Certificate.docx",
            mimetype='application/vnd.openxmlformats-officedocument.wordprocessingml.document'
        )

    except Exception as e:
        print(f"❌ Error processing API first audit certificate: {e}")
        traceback.print_exc()
