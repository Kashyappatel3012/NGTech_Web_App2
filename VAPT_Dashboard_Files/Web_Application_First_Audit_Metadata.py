...
# Create blueprint for Web Application VAPT First Audit MetaData
web_application_first_audit_metadata_bp = Blueprint('web_application_first_audit_metadata', __name__)

def create_web_application_first_audit_metadata_excel(form_data):
    ...
    try:
        ...
        filename = 'Web_Application_First_Audit_MetaData.xlsx'
...
@web_application_first_audit_metadata_bp.route('/process_web_application_vapt_first_audit_metadata', methods=['POST'])
def process_web_application_vapt_first_audit_metadata():
    """Process Web Application VAPT First Audit MetaData form submission"""
    try:
        print("\n" + "="*80)
        ...
        # Create Excel file
        filepath, filename = create_web_application_first_audit_metadata_excel(form_data)
...
# Cleanup endpoint
@web_application_first_audit_metadata_bp.route('/cleanup_web_application_vapt_first_audit_metadata', methods=['POST'])
def cleanup_web_application_vapt_first_audit_metadata():
    """Clean up old Web Application VAPT First Audit MetaData Excel files"""
    try:
        uploads_dir = os.path.join('static', 'uploads')
        if os.path.exists(uploads_dir):
            target_file = 'Web_Application_First_Audit_MetaData.xlsx'
