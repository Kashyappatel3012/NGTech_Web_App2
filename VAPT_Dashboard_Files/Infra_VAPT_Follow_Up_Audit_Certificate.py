...
vapt_follow_up_audit_certificate_bp = Blueprint('vapt_follow_up_audit_certificate', __name__)
...
def generate_vapt_follow_up_audit_certificate(organization_name, city, state, auditee_designation, scope,
                                       start_audit_date, end_audit_date, first_report_id, report_id):
    """
    Generate a Infrastructure VAPT Follow Up Audit Completion Certificate document by copying the template and replacing placeholders
    """
    try:
        # Path to the template file
        template_path = os.path.join('static', 'Formats_and_Catalog', 'Infrastructure_VAPT_Follow_Up_Audit_Conduct_Certificate.docx')
        ...
        import shutil
        certificate_filename = "Infrastrcture_VAPT_Follow_Up_Certificate.docx"
...
@vapt_follow_up_audit_certificate_bp.route('/process_vapt_follow_up_audit_certificate', methods=['POST'])
def process_vapt_follow_up_audit_certificate():
    """
    Process the certificate form data and generate a Infrastructure VAPT Follow Up Audit Completion Certificate
    """
    try:
        # Get form data
        ...
        certificate_path = generate_vapt_follow_up_audit_certificate(
        ...
        return send_file(
            certificate_path,
            as_attachment=True,
            download_name="Infrastrcture_VAPT_Follow_Up_Certificate.docx",
