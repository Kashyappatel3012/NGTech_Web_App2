...
# Create blueprint for Website VAPT First Audit Certificate generation
website_vapt_first_audit_certificate_bp = Blueprint('website_vapt_first_audit_certificate', __name__)
...
def generate_website_vapt_first_audit_certificate(organization_name, city, state, auditee_designation, scope,
                                   start_audit_date, end_audit_date, report_id):
    """
    Generate a Website VAPT First Audit Completion Certificate document by copying the template and replacing placeholders
    """
    try:
        # Path to the template file
        template_path = os.path.join('static', 'Formats_and_Catalog', 'Website_VAPT_First_Audit_Conduct_Certificate.docx')
        ...
        import shutil
        certificate_filename = "Website_VAPT_Certificate.docx"
...
@website_vapt_first_audit_certificate_bp.route('/process_website_vapt_first_audit_certificate', methods=['POST'])
def process_website_vapt_first_audit_certificate():
    """
    Process the certificate form data and generate a Website VAPT First Audit Completion Certificate
    """
    try:
        # Get form data
        ...
        certificate_path = generate_website_vapt_first_audit_certificate(
        ...
        return send_file(
            certificate_path,
            as_attachment=True,
            download_name="Website_VAPT_Certificate.docx",
