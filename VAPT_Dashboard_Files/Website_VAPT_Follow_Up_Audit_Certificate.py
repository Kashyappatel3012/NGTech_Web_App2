...
# Create blueprint for Website VAPT Follow Up Audit Certificate generation
website_vapt_follow_up_audit_certificate_bp = Blueprint('website_vapt_follow_up_audit_certificate', __name__)
...
def generate_website_vapt_follow_up_audit_certificate(organization_name, city, state, auditee_designation, scope,
                                       start_audit_date, end_audit_date, first_report_id, report_id):
    """
    Generate a Website VAPT Follow Up Audit Completion Certificate document by copying the template and replacing placeholders
    """
    try:
        # Path to the template file
        template_path = os.path.join('static', 'Formats_and_Catalog', 'Website_VAPT_Follow_Up_Audit_Conduct_Certificate.docx')
        ...
        import shutil
        certificate_filename = "Website_VAPT_Follow_Up_Certificate.docx"
...
@website_vapt_follow_up_audit_certificate_bp.route('/process_website_vapt_follow_up_audit_certificate', methods=['POST'])
def process_website_vapt_follow_up_audit_certificate():
    """
    Process the certificate form data and generate a Website VAPT Follow Up Audit Completion Certificate
    """
    try:
        # Get form data
        ...
        certificate_path = generate_website_vapt_follow_up_audit_certificate(
        ...
        return send_file(
            certificate_path,
            as_attachment=True,
            download_name="Website_VAPT_Follow_Up_Certificate.docx",
            mimetype='application/vnd.openxmlformats-officedocument.wordprocessingml.document'
        )
        
    except Exception as e:
        print(f"❌ Error processing VAPT follow up audit certificate: {e}")
        traceback.print_exc()
