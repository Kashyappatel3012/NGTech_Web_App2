...
# Create blueprint for Website VAPT Compliance Certificate
grc_website_vapt_compliance_certificate_bp = Blueprint('grc_website_vapt_compliance_certificate', __name__)
...
def create_website_vapt_compliance_certificate(form_data):
    """Create Website VAPT Compliance Certificate Word document"""
    try:
        print(f"🔍 Starting Website VAPT Compliance Certificate creation...")
        ...
        # Load template
        template_path = os.path.join('static', 'Formats_and_Catalog', 'Website VAPT Compliance Certificate.docx')
        ...
        print(f"   ✅ Website VAPT Compliance Certificate created successfully")
...
@grc_website_vapt_compliance_certificate_bp.route('/grc_process_website_vapt_compliance_certificate', methods=['POST'])
def process_website_vapt_compliance_certificate():
    """Process Website VAPT Compliance Certificate form submission"""
    try:
        print("\n" + "="*80)
        print("🚀 Processing Website VAPT Compliance Certificate")
        print("="*80)
        ...
        doc = create_website_vapt_compliance_certificate(form_data)
        
        # Save the Word document
        filename = 'Website_VAPT_Compliance_Certificate.docx'
        filepath = os.path.join('static', 'uploads', filename)
        
        os.makedirs(os.path.dirname(filepath), exist_ok=True)
        doc.save(filepath)
        
        print(f"\n✅ Website VAPT Compliance Certificate created: {filename}")
        print("="*80)
...
@grc_website_vapt_compliance_certificate_bp.route('/grc_cleanup_website_vapt_compliance_certificate', methods=['POST'])
def cleanup_website_vapt_compliance_certificate():
    """Clean up Website VAPT Compliance Certificate file after download"""
    try:
