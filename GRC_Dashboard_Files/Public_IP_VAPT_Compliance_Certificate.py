...
# Create blueprint for Public IP VAPT Compliance Certificate
grc_public_ip_vapt_compliance_certificate_bp = Blueprint('grc_public_ip_vapt_compliance_certificate', __name__)
...
def create_public_ip_vapt_compliance_certificate(form_data):
    """Create Public IP VAPT Compliance Certificate Word document"""
    try:
        print(f"🔍 Starting Public IP VAPT Compliance Certificate creation...")
        ...
        # Load template
        template_path = os.path.join('static', 'Formats_and_Catalog', 'Public IP VAPT Compliance Certificate.docx')
        ...
        print(f"   ✅ Public IP VAPT Compliance Certificate created successfully")
...
@grc_public_ip_vapt_compliance_certificate_bp.route('/grc_process_public_ip_vapt_compliance_certificate', methods=['POST'])
def process_public_ip_vapt_compliance_certificate():
    """Process Public IP VAPT Compliance Certificate form submission"""
    try:
        print("\n" + "="*80)
        print("🚀 Processing Public IP VAPT Compliance Certificate")
        print("="*80)
        ...
        doc = create_public_ip_vapt_compliance_certificate(form_data)
        
        # Save the Word document
        filename = 'Public_IP_VAPT_Compliance_Certificate.docx'
        filepath = os.path.join('static', 'uploads', filename)
        
        os.makedirs(os.path.dirname(filepath), exist_ok=True)
        doc.save(filepath)
        
        print(f"\n✅ Public IP VAPT Compliance Certificate created: {filename}")
        print("="*80)
...
@grc_public_ip_vapt_compliance_certificate_bp.route('/grc_cleanup_public_ip_vapt_compliance_certificate', methods=['POST'])
def cleanup_public_ip_vapt_compliance_certificate():
    """Clean up Public IP VAPT Compliance Certificate file after download"""
    try:
