...
grc_infrastructure_vapt_compliance_certificate_bp = Blueprint('grc_infrastructure_vapt_compliance_certificate', __name__)
...
@grc_infrastructure_vapt_compliance_certificate_bp.route('/grc_process_infrastructure_vapt_compliance_certificate', methods=['POST'])
...
@grc_infrastructure_vapt_compliance_certificate_bp.route('/grc_cleanup_infrastructure_vapt_compliance_certificate', methods=['POST'])
