...
grc_website_vapt_compliance_bp = Blueprint('grc_website_vapt_compliance', __name__)
...
@grc_website_vapt_compliance_bp.route('/grc_process_website_vapt_compliance', methods=['POST'])
...
@grc_website_vapt_compliance_bp.route('/grc_cleanup_website_vapt_compliance', methods=['POST'])
