"""
Script to update HR Manager browser fingerprint in database
"""
import os
import sys
...
def update_hr_manager_fingerprint(new_fingerprint):
    ...
    with app.app_context():
        ...
        try:
            ...
            # Verify the update
            verify_employee_data = EmployeeData.query.filter_by(user_id=hr_manager.id).first()
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: python update_hr_manager_fingerprint.py <new_fingerprint>")
        print("Example: python update_hr_manager_fingerprint.py 6fc7c55b2ee9afd4dd8e9454b3a93ca6")
        sys.exit(1)
