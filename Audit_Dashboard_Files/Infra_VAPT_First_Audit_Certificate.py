...
first_audit_certificate_bp = Blueprint('first_audit_certificate', __name__)
...
def generate_first_audit_certificate(organization_name, city, state, auditee_designation, scope,
                                   start_audit_date, end_audit_date, report_id):
    """
    Generate a First Audit Conducted Certificate document by copying the template and replacing placeholders
    """
    try:
...
@first_audit_certificate_bp.route('/process_first_audit_certificate', methods=['POST'])
def process_first_audit_certificate():
    """
    Process the certificate form data and generate a First Audit Conducted Certificate
    """
    try:
        # Get form data
        ...
        certificate_path = generate_first_audit_certificate(
        ...
        print(f"❌ Error processing first audit certificate: {e}")
        traceback.print_exc()
