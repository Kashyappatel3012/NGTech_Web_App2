...
# Create blueprint for IS Audit Compliance
is_audit_compliance_bp = Blueprint('is_audit_compliance', __name__)
...
@is_audit_compliance_bp.route('/process_is_audit_compliance', methods=['POST'])
...
@is_audit_compliance_bp.route('/cleanup_is_audit_compliance', methods=['POST'])
