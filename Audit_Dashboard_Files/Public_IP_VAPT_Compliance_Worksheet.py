...
public_ip_vapt_compliance_bp = Blueprint('public_ip_vapt_compliance', __name__)
...
@public_ip_vapt_compliance_bp.route('/process_public_ip_vapt_compliance', methods=['POST'])
...
@public_ip_vapt_compliance_bp.route('/cleanup_public_ip_vapt_compliance', methods=['POST'])
