...
cyber_security_audit_certificate_bp = Blueprint('cyber_security_audit_certificate', __name__)
...
def generate_cyber_security_audit_certificate(organization_name, city, state, auditee_designation,
                                   start_audit_date, end_audit_date, report_id):
    """
    Generate a Cyber Security Audit Conducted Certificate document by copying the template and replacing placeholders
    """
    try:
        # Path to the template file
        template_path = os.path.join('static', 'Formats_and_Catalog', 'Cyber_Security_Audit_Conduct_Certificate.docx')
        ...
        import shutil
        certificate_filename = "Cyber_Security_Audit_Certificate.docx"
...
@cyber_security_audit_certificate_bp.route('/process_cyber_security_audit_certificate', methods=['POST'])
def process_cyber_security_audit_certificate():
    """
    Process the certificate form data and generate a Cyber Security Audit Conducted Certificate
    """
    try:
        # Get form data
        ...
        if not all([organization_name, city, state, auditee_designation, start_audit_date, end_audit_date, report_id]):
        ...
        certificate_path = generate_cyber_security_audit_certificate(
            organization_name, city, state, auditee_designation,
            start_audit_date, end_audit_date, report_id
        )
        ...
        return send_file(
            certificate_path,
            as_attachment=True,
            download_name="Cyber_Security_Audit_Certificate.docx",
            mimetype='application/vnd.openxmlformats-officedocument.wordprocessingml.document'
        )
        
    except Exception as e:
        print(f"❌ Error processing Cyber Security audit certificate: {e}")
        traceback.print_exc()
