...
website_vapt_compliance_certificate_bp = Blueprint('website_vapt_compliance_certificate', __name__)
...
@website_vapt_compliance_certificate_bp.route('/process_website_vapt_compliance_certificate', methods=['POST'])
...
@website_vapt_compliance_certificate_bp.route('/cleanup_website_vapt_compliance_certificate', methods=['POST'])
