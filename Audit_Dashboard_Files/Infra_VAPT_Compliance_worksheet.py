...
infra_vapt_compliance_bp = Blueprint('infra_vapt_compliance', __name__)
...
@infra_vapt_compliance_bp.route('/process_infra_vapt_compliance', methods=['POST'])
...
@infra_vapt_compliance_bp.route('/cleanup_infra_vapt_compliance', methods=['POST'])
