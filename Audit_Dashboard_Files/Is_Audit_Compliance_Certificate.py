...
# Create blueprint for IS Audit Compliance Certificate
is_audit_compliance_certificate_bp = Blueprint('is_audit_compliance_certificate', __name__)
...
@is_audit_compliance_certificate_bp.route('/process_is_audit_compliance_certificate', methods=['POST'])
...
@is_audit_compliance_certificate_bp.route('/cleanup_is_audit_compliance_certificate', methods=['POST'])
