...
gap_assessment_audit_certificate_bp = Blueprint('gap_assessment_audit_certificate', __name__)
...
def generate_gap_assessment_audit_certificate(organization_name, city, state, auditee_designation,
                                   start_audit_date, end_audit_date, report_id):
    """
    Generate a Gap Assessment Audit Conducted Certificate document by copying the template and replacing placeholders
    """
    try:
        # Path to the template file
        template_path = os.path.join('static', 'Formats_and_Catalog', 'Gap_Assessment_Audit_Conduct_Certificate.docx')
        ...
        import shutil
        certificate_filename = "Gap_Assessment_Audit_Certificate.docx"
...
@gap_assessment_audit_certificate_bp.route('/process_gap_assessment_audit_certificate', methods=['POST'])
def process_gap_assessment_audit_certificate():
    """
    Process the certificate form data and generate a Gap Assessment Audit Conducted Certificate
    """
    try:
        # Get form data
        ...
        certificate_path = generate_gap_assessment_audit_certificate(
        ...
        return send_file(
            certificate_path,
            as_attachment=True,
            download_name="Gap_Assessment_Audit_Certificate.docx",
            mimetype='application/vnd.openxmlformats-officedocument.wordprocessingml.document'
        )
        
    except Exception as e:
        print(f"❌ Error processing Gap Assessment audit certificate: {e}")
        traceback.print_exc()
