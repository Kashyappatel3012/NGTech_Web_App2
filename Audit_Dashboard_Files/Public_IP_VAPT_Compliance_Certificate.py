...
public_ip_vapt_compliance_certificate_bp = Blueprint('public_ip_vapt_compliance_certificate', __name__)
...
@public_ip_vapt_compliance_certificate_bp.route('/process_public_ip_vapt_compliance_certificate', methods=['POST'])
...
@public_ip_vapt_compliance_certificate_bp.route('/cleanup_public_ip_vapt_compliance_certificate', methods=['POST'])
