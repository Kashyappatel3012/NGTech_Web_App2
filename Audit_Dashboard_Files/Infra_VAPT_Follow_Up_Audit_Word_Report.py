...
follow_up_word_report_bp = Blueprint('follow_up_word_report', __name__)
...
def replace_a11_row_with_vulnerabilities(doc, excel_file):
    ...
    try:
        ...
        for idx in range(len(df)):
            ...
            # Column 4: CVE ID (Excel column E, index 4)
...
@follow_up_word_report_bp.route('/process_follow_up_audit_word_report', methods=['POST'])
