...
follow_up_audit_certificate_bp = Blueprint('follow_up_audit_certificate', __name__)
...
def generate_follow_up_audit_certificate(organization_name, city, state, auditee_designation, scope,
                                       start_audit_date, end_audit_date, report_id):
    """
    Generate a Follow Up Audit Conducted Certificate document by copying the template and replacing placeholders
    """
    try:
        ...
        replacements = {
            ...
            "XXXXXXXXX": report_id  # Replace XXXXXXXXX with Report ID
        }
...
@follow_up_audit_certificate_bp.route('/process_follow_up_audit_certificate', methods=['POST'])
def process_follow_up_audit_certificate():
    """
    Process the certificate form data and generate a Follow Up Audit Conducted Certificate
    """
    try:
        # Get form data
        ...
        certificate_path = generate_follow_up_audit_certificate(
        ...
        print(f"❌ Error processing follow up audit certificate: {e}")
        traceback.print_exc()
